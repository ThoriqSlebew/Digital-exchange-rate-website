<div>
    <header class="mt-24 mb-16 mx-24">
        <img src="{{ asset('img/logo-britama-bisnis.png') }}" alt="Logo Header" id="animate" class="mx-auto w-1/2">
        <p id="animate" class="font-montserrat text-xl tracking-wide text-white text-center mt-10">
            BritAma Bisnis adalah produk tabungan BRI yang diperuntukkan bagi para pelaku usaha, baik perorangan maupun
            badan usaha.
        </p>
    </header>
    <main class="mx-20 font-montserrat tracking-widest">
        @php
            $firstRow = $valuesBritamaBisnis[0];
        @endphp
        ...
        @foreach (array_slice($valuesBritamaBisnis, 1) as $row)
