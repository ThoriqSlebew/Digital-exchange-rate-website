<div>
    <header class="mt-24 mb-16 mx-24">
        <img src="{{ asset('img/logo-britama.png') }}" alt="Logo Header" id="animate" class="mx-auto w-1/2">
        <p id="animate" class="font-montserrat text-xl tracking-wide text-white text-center mt-10">
            BritAma adalah produk tabungan dari Bank BRI yang populer di kalangan penduduk kota yang bersedia membayar
            lebih untuk membuka rekening.
        </p>
    </header>
    <main class="mx-20 font-montserrat tracking-widest">
        @php
            $firstRow = $valuesBritama[0];
        @endphp
        ...
        @foreach (array_slice($valuesBritama, 1) as $row)
