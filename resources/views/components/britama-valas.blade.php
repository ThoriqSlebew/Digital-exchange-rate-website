<div>
    <header class="mt-24 mb-16 mx-24">
        <img src="{{ asset('img/logo-britama-valas.png') }}" alt="Logo Header" id="animate" class="mx-auto w-1/2">
        <p id="animate" class="font-montserrat text-xl tracking-wide text-white text-center mt-10">
            BritAma Valas adalah tabungan dalam mata uang asing dengan menawarkan kemudahan transaksi dan nilai tukar
            yang kompetitif.
        </p>
    </header>
    <main class="mx-20 font-montserrat tracking-widest">
        @php
            $firstRow = $valuesBritamaValas[0];
        @endphp
        ...
        @foreach (array_slice($valuesBritamaValas, 1) as $row)
