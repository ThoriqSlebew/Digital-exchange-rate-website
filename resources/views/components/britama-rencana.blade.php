<div>
    <header class="mt-24 mb-16 mx-24">
        <img src="{{ asset('img/logo-britama-rencana.png') }}" alt="Logo Header" id="animate" class="mx-auto w-1/2">
        <p id="animate" class="font-montserrat text-xl tracking-wide text-white text-center mt-10">
            BritAma Rencana adalah tabungan berjangka BRI yang mengharuskan nasabah berkomitmen menabung dalam jangka
            waktu tertentu.
        </p>
    </header>
    <main class="mx-20 font-montserrat tracking-widest">
        @php
            $firstRow = $valuesBritamaRencana[0];
        @endphp
        ...
        @foreach (array_slice($valuesBritamaRencana, 1) as $row)
