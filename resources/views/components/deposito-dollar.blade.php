<div>
    <header class="mt-24 mb-16 mx-24">
        <img src="{{ asset('img/logo-deposito-dollar.png') }}" alt="Logo Header" id="animate" class="mx-auto w-1/2">
        <p id="animate" class="font-montserrat text-xl tracking-wide text-white text-center mt-10">
            Deposito dollar adalah simpanan berjangka dalam mata uang asing yang hanya bisa ditarik pada jangka waktu
    ...
    <main class="mx-20 font-montserrat tracking-widest">
        @php
            $firstRow = $valuesDepositoDollar[0];
        @endphp
        ...
        @foreach (array_slice($valuesDepositoDollar, 1) as $row)
