<div>
    <header class="mt-24 mb-16 mx-24">
        <img src="{{ asset('img/logo-simpedes-impian.png') }}" alt="Logo Header" id="animate" class="mx-auto w-1/2">
        <p id="animate" class="font-montserrat text-xl tracking-wide text-white text-center mt-10">
            Simpedes Impian adalah konsep tabungan berjangka yang bebas dari biaya administrasi.
        </p>
    </header>
    <main class="mx-20 font-montserrat tracking-widest">
        @php
            $firstRow = $valuesSimpedesImpian[0];
        @endphp
        ...
        @foreach (array_slice($valuesSimpedesImpian, 1) as $row)
